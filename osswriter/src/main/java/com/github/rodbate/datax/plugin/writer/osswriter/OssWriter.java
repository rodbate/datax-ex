package com.github.rodbate.datax.plugin.writer.osswriter;
...
import com.github.rodbate.datax.plugin.unstructuredstorage.writer.Constant;
import com.github.rodbate.datax.plugin.unstructuredstorage.writer.TextCsvWriterManager;
import com.github.rodbate.datax.plugin.unstructuredstorage.writer.UnstructuredStorageWriterUtil;
import com.github.rodbate.datax.plugin.unstructuredstorage.writer.UnstructuredWriter;
...
import com.github.rodbate.datax.plugin.writer.osswriter.util.OssUtil;
    ...
    public static class Job extends Writer.Job {
        ...
        private void validateParameter() {
            ...
            String compress = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.COMPRESS);
        ...
        public void prepare() {
            ...
            String writeMode = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.WRITE_MODE);
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            this.nullFormat = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.NULL_FORMAT);
            this.dateFormat = this.writerSliceConfig
                    .getString(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.DATE_FORMAT,
                            null);
            ...
            this.encoding = this.writerSliceConfig
                    .getString(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.ENCODING,
                            Constant.DEFAULT_ENCODING);
            this.fieldDelimiter = this.writerSliceConfig
                    .getChar(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FIELD_DELIMITER,
                            Constant.DEFAULT_FIELD_DELIMITER);
            this.fileFormat = this.writerSliceConfig
                    .getString(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FILE_FORMAT,
                            Constant.FILE_FORMAT_TEXT);
            this.header = this.writerSliceConfig
                    .getList(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.HEADER,
                            null, String.class);
            this.maxFileSize = this.writerSliceConfig
                    .getLong(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.MAX_FILE_SIZE,
                            Constant.MAX_FILE_SIZE);
            this.suffix = this.writerSliceConfig
                    .getString(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.SUFFIX,
