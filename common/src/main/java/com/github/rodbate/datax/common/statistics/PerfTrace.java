package com.github.rodbate.datax.common.statistics;

import com.github.rodbate.datax.common.util.Configuration;
import com.github.rodbate.datax.common.util.HostUtils;
...
public class PerfTrace {
    ...
    //PHASE => PerfRecord
    private ConcurrentHashMap<PerfRecord.PHASE, SumPerfRecord4Print> perfRecordMaps4print = new ConcurrentHashMap<PerfRecord.PHASE, SumPerfRecord4Print>();
