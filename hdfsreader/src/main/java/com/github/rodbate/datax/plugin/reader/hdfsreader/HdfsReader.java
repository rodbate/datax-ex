package com.github.rodbate.datax.plugin.reader.hdfsreader;
...
import com.github.rodbate.datax.plugin.unstructuredstorage.reader.UnstructuredStorageReaderUtil;
...
public class HdfsReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void validate() {
            ...
            encoding = this.readerOriginConfig.getString(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.ENCODING, "UTF-8");
        ...
        private void validateColumns() {
            ...
            List<Configuration> column = this.readerOriginConfig
                .getListConfiguration(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.COLUMN);
            if (null != column
                && 1 == column.size()
                && ("\"*\"".equals(column.get(0).toString()) || "'*'"
                .equals(column.get(0).toString()))) {
                readerOriginConfig
                    .set(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.COLUMN, new ArrayList<String>());
            } else {
                ...
                for (Configuration eachColumnConf : columns) {
                    eachColumnConf.getNecessaryValue(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.TYPE, HdfsReaderErrorCode.REQUIRED_VALUE);
                    Integer columnIndex = eachColumnConf.getInt(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.INDEX);
                    String columnValue = eachColumnConf.getString(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.VALUE);
    ...
    public static class Task extends Reader.Task {
        ...
        public void init() {
            ...
            this.encoding = this.taskConfig.getString(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.ENCODING, "UTF-8");
            this.dfsUtil = new DFSUtil(this.taskConfig);
            this.bufferSize = this.taskConfig.getInt(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.BUFFER_SIZE,
                com.github.rodbate.datax.plugin.unstructuredstorage.reader.Constant.DEFAULT_BUFFER_SIZE);
        }
