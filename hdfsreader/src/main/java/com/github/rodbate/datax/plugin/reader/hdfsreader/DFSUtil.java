...
import com.github.rodbate.datax.plugin.unstructuredstorage.reader.ColumnEntry;
...
public class DFSUtil {
    ...
    public void rcFileStartRead(String sourceRcFilePath, Configuration readerSliceConfig,
        ...
        List<ColumnEntry> column = UnstructuredStorageReaderUtil
                .getListColumnEntry(readerSliceConfig, com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.COLUMN);
        // warn: no default value '\N'
        String nullFormat = readerSliceConfig.getString(com.github.rodbate.datax.plugin.unstructuredstorage.reader.Key.NULL_FORMAT);
