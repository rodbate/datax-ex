package com.github.rodbate.datax.plugin.writer.txtfilewriter;
    ...
    public static class Job extends Writer.Job {
        ...
        public void init() {
            ...
            String dateFormatOld = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FORMAT);
            String dateFormatNew = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.DATE_FORMAT);
            if (null == dateFormatNew) {
                this.writerSliceConfig
                        .set(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.DATE_FORMAT,
                                dateFormatOld);
            }
        ...
        public List<Configuration> split(int mandatoryNumber) {
            ...
            for (int i = 0; i < mandatoryNumber; i++) {
                ...
                splitedTaskConfig
                        .set(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FILE_NAME,
                                fullFileName);
