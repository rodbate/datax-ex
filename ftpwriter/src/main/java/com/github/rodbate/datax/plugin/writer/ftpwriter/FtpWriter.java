package com.github.rodbate.datax.plugin.writer.ftpwriter;
...
import com.github.rodbate.datax.plugin.writer.ftpwriter.util.Constant;
import com.github.rodbate.datax.plugin.writer.ftpwriter.util.IFtpHelper;
import com.github.rodbate.datax.plugin.writer.ftpwriter.util.SftpHelperImpl;
import com.github.rodbate.datax.plugin.writer.ftpwriter.util.StandardFtpHelperImpl;
    ...
    public static class Job extends Writer.Job {
        ...
        private void validateParameter() {
            this.writerSliceConfig
                    .getNecessaryValue(
                            com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FILE_NAME,
        ...
        public void prepare() {
            ...
            String fileName = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.FILE_NAME);
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            this.suffix = this.writerSliceConfig
                    .getString(com.github.rodbate.datax.plugin.unstructuredstorage.writer.Key.SUFFIX);
