package com.github.rodbate.datax.plugin.rdbms.reader;

import com.github.rodbate.datax.common.element.*;
...
import com.github.rodbate.datax.common.statistics.PerfRecord;
import com.github.rodbate.datax.common.statistics.PerfTrace;
import com.github.rodbate.datax.common.util.Configuration;
import com.github.rodbate.datax.plugin.rdbms.reader.util.OriginalConfPretreatmentUtil;
import com.github.rodbate.datax.plugin.rdbms.reader.util.PreCheckTask;
import com.github.rodbate.datax.plugin.rdbms.reader.util.ReaderSplitUtil;
import com.github.rodbate.datax.plugin.rdbms.reader.util.SingleTableSplitUtil;
import com.github.rodbate.datax.plugin.rdbms.util.DataBaseType;
import com.github.rodbate.datax.plugin.rdbms.util.DBUtil;
import com.github.rodbate.datax.plugin.rdbms.util.DBUtilErrorCode;
import com.github.rodbate.datax.plugin.rdbms.util.RdbmsException;
...
public class CommonRdbmsReader {
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(com.github.rodbate.datax.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(com.github.rodbate.datax.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
