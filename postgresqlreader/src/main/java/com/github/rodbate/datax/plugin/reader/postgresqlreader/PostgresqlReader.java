package com.github.rodbate.datax.plugin.reader.postgresqlreader;
...
public class PostgresqlReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            int fetchSize = this.originalConfig.getInt(com.github.rodbate.datax.plugin.rdbms.reader.Constant.FETCH_SIZE,
            ...
            this.originalConfig.set(com.github.rodbate.datax.plugin.rdbms.reader.Constant.FETCH_SIZE, fetchSize);
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(RecordSender recordSender) {
            int fetchSize = this.readerSliceConfig.getInt(com.github.rodbate.datax.plugin.rdbms.reader.Constant.FETCH_SIZE);
