package com.github.rodbate.datax.plugin.writer.hbase094xwriter;
...
public class Hbase094xHelper {
    ...
    public static HTable getTable(Configuration configuration){
    ...
    public  static  void validateMode(Configuration originalConfig){
    ...
    public static void validateColumn(Configuration originalConfig){
    ...
    public static void validateRowkeyColumn(Configuration originalConfig){
    ...
    public static void validateVersionColumn(Configuration originalConfig){
