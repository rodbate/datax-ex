package com.github.rodbate.datax.plugin.reader.oraclereader;
...
import com.github.rodbate.datax.plugin.rdbms.reader.CommonRdbmsReader;
import com.github.rodbate.datax.plugin.rdbms.reader.Key;
import com.github.rodbate.datax.plugin.rdbms.reader.util.HintUtil;
	...
	public static class Job extends Reader.Job {
		...
		private void dealFetchSize(Configuration originalConfig) {
			int fetchSize = originalConfig.getInt(
					com.github.rodbate.datax.plugin.rdbms.reader.Constant.FETCH_SIZE,
		...
		private void dealHint(Configuration originalConfig) {
			...
			if (StringUtils.isNotBlank(hint)) {
				boolean isTableMode = originalConfig.getBool(com.github.rodbate.datax.plugin.rdbms.reader.Constant.IS_TABLE_MODE).booleanValue();
				if(!isTableMode){
	...
	public static class Task extends Reader.Task {
		...
		public void startRead(RecordSender recordSender) {
			int fetchSize = this.readerSliceConfig
					.getInt(com.github.rodbate.datax.plugin.rdbms.reader.Constant.FETCH_SIZE);
