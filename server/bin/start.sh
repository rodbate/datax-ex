...
BASE_DIR=$(dirname $0)/..
CLASSPATH=.:${BASE_DIR}/*:${BASE_DIR}/conf:${BASE_DIR}/libs/*:${CLASSPATH}
...
nohup $JAVA ${JAVA_OPT} com.globalegrow.datax.server.DataXServerApplication $@ > ${BASE_DIR}/start.out 2>&1 &