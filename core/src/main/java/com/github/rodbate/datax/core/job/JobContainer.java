package com.github.rodbate.datax.core.job;
...
import com.github.rodbate.datax.common.plugin.AbstractJobPlugin;
import com.github.rodbate.datax.common.plugin.JobPluginCollector;
...
import com.github.rodbate.datax.common.util.StrUtil;
import com.github.rodbate.datax.core.container.util.HookInvoker;
import com.github.rodbate.datax.core.container.util.JobAssignUtil;
import com.github.rodbate.datax.core.job.scheduler.AbstractScheduler;
import com.github.rodbate.datax.core.job.scheduler.processinner.StandAloneScheduler;
...
import com.github.rodbate.datax.core.statistics.container.communicator.job.StandAloneJobContainerCommunicator;
import com.github.rodbate.datax.core.statistics.plugin.DefaultJobPluginCollector;
import com.github.rodbate.datax.core.util.ErrorRecordChecker;
import com.github.rodbate.datax.core.util.FrameworkErrorCode;
import com.github.rodbate.datax.core.util.container.ClassLoaderSwapper;
...
import com.github.rodbate.datax.dataxservice.face.domain.enums.ExecuteMode;
import com.github.rodbate.datax.core.AbstractContainer;
...
public class JobContainer extends AbstractContainer {
    ...
    private void schedule() {
        ...
        try {
            ...
            this.scheduler = initStandaloneScheduler(this.configuration);
            ...
            this.scheduler.schedule(taskGroupConfigs);
    ...
    private void logStatistics() {
        ...
        LOG.info(String.format(
            "\n" + "%-26s: %-18s\n" + "%-26s: %-18s\n" + "%-26s: %19s\n"
                ...
                + "%-26s: %19s\n",
            "任务启动时刻",
            DATE_TIME_FORMATTER.format(Instant.ofEpochMilli(startTimeStamp)),

            "任务结束时刻",
            DATE_TIME_FORMATTER.format(Instant.ofEpochMilli(endTimeStamp)),
