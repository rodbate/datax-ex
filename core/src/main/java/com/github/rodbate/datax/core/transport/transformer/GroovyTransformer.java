...
public class GroovyTransformer extends Transformer {
    ...
    private String getGroovyRule(String expression, List<String> extraPackagesStrList) {
        ...
        sb.append("import static com.globalegrow.datax.core.transport.transformer.GroovyTransformerStaticUtil.*;");
        sb.append("import com.globalegrow.datax.common.element.*;");
        sb.append("import com.globalegrow.datax.common.exception.DataXException;");
        sb.append("import com.globalegrow.datax.transformer.Transformer;");
